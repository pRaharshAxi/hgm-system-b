...
const sampleListings = [
  ...
  { id: '7', title: 'Red Onions', description: 'Crisp home-grown local red onions.', category: 'VEGETABLES', price: 320, quantity: 45, unit: 'kg', supplierId: 'sup-7', supplierName: 'Urban Veggie', supplierRating: 4.1, latitude: 6.8800, longitude: 79.8600, location: { lat: 6.8800, lon: 79.8600 }, images: [], isActive: true, createdAt: new Date('2026-01-07').toISOString() },
